...
import java.DbPack.TrippleDes;
import java.io.IOException;
import java.io.PrintWriter;
import java.org.dailywtf.string.IndexWrapper;
import java.sql.*;
...
import action.WholeWordIndexFinder;
import action.mail_Send0;
...
//            String ukey = username+userid;
               WholeWordIndexFinder finder = new WholeWordIndexFinder(twitts);
                List<action.IndexWrapper> indexes = finder.findIndexesForKeyword("traffic");
                List<action.IndexWrapper> indexes1 = finder.findIndexesForKeyword("Traffic");
                 List<action.IndexWrapper> indexes2 = finder.findIndexesForKeyword("TRAFFIC");
                List<action.IndexWrapper> indexes3 = finder.findIndexesForKeyword("stuck");
                List<action.IndexWrapper> indexes4 = finder.findIndexesForKeyword("Stuck");
                List<action.IndexWrapper> indexes5 = finder.findIndexesForKeyword("STUCK");
                 List<action.IndexWrapper> indexes6 = finder.findIndexesForKeyword("STRUCK");
                 List<action.IndexWrapper> indexes7 = finder.findIndexesForKeyword("Struck");
                 List<action.IndexWrapper> indexes8 = finder.findIndexesForKeyword("struck");
                 List<action.IndexWrapper> indexes9 = finder.findIndexesForKeyword("ROAD");
                 List<action.IndexWrapper> indexes10 = finder.findIndexesForKeyword("road");
                 List<action.IndexWrapper> indexes11 = finder.findIndexesForKeyword("Road");
